<template>
    <svg :class="classes" fill="currentColor" viewBox="-70 0 652 512">
...
const props = defineProps({
    tier: {
        type: String,
        required: true,
        validator: v => ['platinum', 'gold', 'silver', 'bronze'].includes(v),
    },
    size: {
        type: String,
        default: 'sm',
...
const colorClass = {
    platinum: 'text-blue-300 dark:text-blue-200',
