<template>
    <div v-if="show" class="fixed inset-0 z-50 overflow-y-auto" @click.self="closeModal">
        <div class="flex items-center justify-center min-h-screen px-4">
            ...
            <!-- Modal -->
            <div class="relative bg-white dark:bg-slate-800 rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
                <!-- Header -->
                <div class="sticky top-0 bg-white dark:bg-slate-800 border-b dark:border-slate-700 px-6 py-4 flex justify-between items-center z-10">
                    <div>
                        ...
                        <div v-if="isEdit && (game?.psnprofiles_url || game?.playstationtrophies_url || game?.powerpyx_url)" class="flex items-center gap-2 mt-1">
                            <span class="text-xs text-gray-500 dark:text-gray-400">Open guide:</span>
                            <a
                                v-if="game?.psnprofiles_url"
                                :href="game.psnprofiles_url"
                                target="_blank"
                                rel="noopener noreferrer"
                                class="inline-flex items-center gap-1 px-2 py-1 bg-blue-100 dark:bg-blue-900/50 text-blue-700 dark:text-blue-300 rounded text-xs font-medium hover:bg-blue-200 dark:hover:bg-blue-900/70"
                            >
                            ...
                            <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                class="inline-flex items-center gap-1 px-2 py-1 bg-orange-100 dark:bg-orange-900/50 text-orange-700 dark:text-orange-300 rounded text-xs font-medium hover:bg-orange-200 dark:hover:bg-orange-900/70"
                            >
                                <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"/>
                                </svg>
                ...
                <form @submit.prevent="submitForm" class="p-6 space-y-6">
                    ...
                    <div class="space-y-4">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white border-b dark:border-slate-700 pb-2">Trophy Data</h3>
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <select
                                ...
                                :class="[
                                    ...
                                    form.data_source === 'playstationtrophies' ? 'bg-purple-100 text-purple-700 dark:bg-purple-900/50 dark:text-purple-300' :
                                    form.data_source === 'powerpyx' ? 'bg-orange-100 text-orange-700 dark:bg-orange-900/50 dark:text-orange-300' :
                                    form.data_source === 'psnprofiles' ? 'bg-blue-100 text-blue-700 dark:bg-blue-900/50 dark:text-blue-300' :
                        ...
                        <div class="grid grid-cols-6 gap-3 items-end">
                            <div>
                                <label class="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-1">Difficulty</label>
                                <input
                                    ...
                                    max="10"
                                    step="1"
                                    class="w-full px-2 py-2 border border-gray-300 dark:border-slate-600 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm bg-white dark:bg-slate-700 dark:text-white"
                                    placeholder="1-10"
                                />
                            </div>
                            <div>
                                <label class="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-1">Playthroughs</label>
                                <input
                            ...
                            <div>
                                <label class="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-1">Hours (min-max)</label>
                            ...
                            <label class="flex items-center space-x-2 cursor-pointer pb-2">
                                ...
                                />
                                <span class="text-xs font-medium text-gray-700 dark:text-gray-300">Online</span>
                            </label>
                            <label class="flex items-center space-x-2 cursor-pointer pb-2">
                                <input
                                    ...
                                    class="w-4 h-4 text-blue-600 rounded focus:ring-2 focus:ring-blue-500"
                                />
                                <span class="text-xs font-medium text-gray-700 dark:text-gray-300">Missable</span>
                            </label>
                            <label class="flex items-center space-x-2 cursor-pointer pb-2">
                                <input
                                ...
                                />
                                <span class="text-xs font-medium text-gray-700 dark:text-gray-300">Platinum</span>
                            </label>
                        </div>
                        ...
                        <div class="p-3 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg">
                            <label class="flex items-center space-x-3 cursor-pointer">
                                ...
                                />
                                <div>
                                    <span class="text-sm font-semibold text-green-700 dark:text-green-400">Mark as Verified</span>
                                    <p class="text-xs text-green-600 dark:text-green-500">Data has been manually checked and confirmed accurate</p>
                                </div>
                            </label>
                        </div>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                                ...
                                <span class="text-xs text-gray-400 dark:text-gray-500 ml-2">Paste to auto-save, or Enter to save manually</span>
                            </label>
                            <textarea
                                v-model="guideText"
                                @paste="onGuidePaste"
                                ...
                                rows="3"
                                class="w-full px-3 py-2 border border-gray-300 dark:border-slate-600 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm font-mono bg-white dark:bg-slate-700 dark:text-white dark:placeholder-gray-400"
...
Online Trophies: None"
                            ></textarea>
                            <p v-if="parsedFields.length > 0" class="text-xs text-green-600 dark:text-green-400 mt-1">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                type="text"
                                required
                                class="w-full px-3 py-2 border border-gray-300 dark:border-slate-600 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white dark:bg-slate-700 dark:text-white"
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Developer</label>
                                <input
                        ...
                        <!-- Release Date -->
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Release Date</label>
                            <input
                    ...
                    <div class="space-y-4">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white border-b dark:border-slate-700 pb-2">Server & Obtainability</h3>

                        <!-- Server Shutdown Date -->
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Server Shutdown Date</label>
                            <input
                        ...
                        <div class="p-3 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg">
                            <label class="flex items-center space-x-3 cursor-pointer">
                                ...
                                />
                                <div>
                                    <span class="text-sm font-semibold text-red-700 dark:text-red-400">Platinum is Unobtainable</span>
                                    <p class="text-xs text-red-600 dark:text-red-500">Server shutdown, delisted, or otherwise impossible to 100%</p>
                                </div>
                            </label>
                        </div>
                    </div>
                    ...
                    <!-- Scores & Reviews -->
                    <div class="space-y-4">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white border-b dark:border-slate-700 pb-2">Scores & Reviews</h3>

                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Critic Score (0-100)</label>
                                <input
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">OpenCritic Score (0-100)</label>
                                <input
                    ...
                    <!-- Pricing -->
                    <div class="space-y-4">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white border-b dark:border-slate-700 pb-2">Pricing (Optional)</h3>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Amazon Link</label>
                                <input
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Bol.com Link</label>
                                <input
                    ...
                    <!-- Categories -->
                    <div class="space-y-4">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white border-b dark:border-slate-700 pb-2">Categories</h3>

                        <!-- Genres -->
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Genres</label>
                            <div class="border border-gray-300 dark:border-slate-600 rounded-md p-3 max-h-48 overflow-y-auto">
                                <label
                                    v-for="genre in genres"
                                    :key="genre.id"
                                    class="flex items-center space-x-2 py-1 hover:bg-gray-50 dark:hover:bg-slate-700/50 cursor-pointer"
                                >
                                    <input
                                        type="checkbox"
                                        :value="genre.id"
                            ...
                            <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Selected: {{ form.genre_ids.length }}</p>
                        </div>
                            ...
                            <div class="border border-gray-300 dark:border-slate-600 rounded-md p-3 max-h-48 overflow-y-auto">
                                ...
                                >
                                    <input
                                        ...
                                        class="w-4 h-4 text-blue-600 rounded focus:ring-2 focus:ring-blue-500"
                                    />
                                    <span class="text-sm dark:text-gray-300">{{ tag.name }}</span>
                                </label>
                            </div>
                            <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Selected: {{ form.tag_ids.length }}</p>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="border border-gray-300 dark:border-slate-600 rounded-md p-3">
                                <label
                                ...
                                >
                                    <input
                                        ...
                                        class="w-4 h-4 text-blue-600 rounded focus:ring-2 focus:ring-blue-500"
                                    />
                                    <span class="text-sm font-medium dark:text-gray-300">{{ platform.name }}</span>
                                </label>
                            </div>
                            <p v-if="errors.platform_ids" class="text-red-500 text-sm mt-1">{{ errors.platform_ids[0] }}</p>
                            <p v-else class="text-xs text-gray-500 dark:text-gray-400 mt-1">At least one platform required. Selected: {{ form.platform_ids.length }}</p>
                        </div>
                    </div>

                    <!-- Images & Links -->
                    <div class="space-y-4">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white border-b dark:border-slate-700 pb-2">Images & External Links</h3>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Banner Image URL</label>
                                <input
                        ...
                        <div class="mb-4">
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                                ...
                                <span class="text-xs text-gray-400 dark:text-gray-500 ml-1">(find guides from other versions/regions)</span>
                            </label>
                            <div class="relative">
                                <input
                                    v-model="guideSearch"
                                    ...
                                    @input="searchGuides"
                                />
                                <svg v-if="guideSearchLoading" class="absolute right-3 top-2.5 w-5 h-5 animate-spin text-gray-400 dark:text-gray-500" fill="none" viewBox="0 0 24 24">
                                    <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                                    <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4z"></path>
                                </svg>
                            </div>
                            <!-- Search Results -->
                            <div v-if="guideSearchResults.length > 0" class="mt-2 border border-gray-200 dark:border-slate-700 rounded-md max-h-60 overflow-y-auto">
                                <div
                                    v-for="result in guideSearchResults"
                                    :key="result.id"
                                    class="p-3 hover:bg-gray-50 dark:hover:bg-slate-700/50 border-b border-gray-100 dark:border-slate-700 last:border-b-0"
                                >
                                    <div class="flex items-start justify-between">
                                        <div class="flex-1 min-w-0">
                                            <p class="font-medium text-sm text-gray-900 dark:text-white truncate">{{ result.title }}</p>
                                            <p class="text-xs text-gray-500 dark:text-gray-400">{{ result.platforms?.map(p => p.short_name).join(', ') }}</p>
                                        </div>
                                    </div>
                            ...
                            <p v-else-if="guideSearch && !guideSearchLoading && guideSearchResults.length === 0" class="text-xs text-gray-500 dark:text-gray-400 mt-1">
                        ...
                        <div class="space-y-3">
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">PSNProfiles URL</label>
                                <input
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">PlayStationTrophies URL</label>
                                <input
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">PowerPyx URL</label>
                                <input
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">PSN Store URL</label>
                                <input
                    ...
                    <div class="flex justify-end space-x-3 pt-4 border-t dark:border-slate-700">
                        <button
                            type="button"
                            @click="closeModal"
                            class="px-4 py-2 border border-gray-300 dark:border-slate-600 rounded-md text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-slate-700/50"
                            :disabled="loading"
                        >
                            Cancel
                        </button>
