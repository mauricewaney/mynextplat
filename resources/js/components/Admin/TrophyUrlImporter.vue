        ...
        <div class="max-w-4xl mx-auto space-y-4">
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center gap-3">
                    <div class="flex items-center gap-2 bg-indigo-600 text-white px-3 py-2 rounded-lg">
            ...
            <div class="bg-white rounded-lg shadow p-4">
                <textarea
                    ...
                    v-model="html"
                    rows="10"
                    class="w-full border-2 border-dashed border-gray-300 rounded-lg focus:border-indigo-500 focus:ring-0 font-mono text-xs p-3"
                ...
                <div class="flex items-center justify-between mt-2">
                    <div class="flex items-center gap-3 text-sm">
                        ...
                        <span v-if="loading" class="text-indigo-600 flex items-center gap-1">
            ...
            <div class="flex gap-4 text-sm">
                ...
                <router-link to="/admin/trophy-urls/unmatched" class="text-indigo-600 hover:text-indigo-800">Unmatched URLs →</router-link>
            </div>
        </div>
    </AdminLayout>
</template>
