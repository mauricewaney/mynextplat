    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        @if($listGamesByDate->isNotEmpty())
            ...
            <div class="lg:hidden mt-8">
                <div class="flex gap-2 mb-4 border-b border-gray-200 dark:border-slate-700/50">
                    <button id="tab-recent" onclick="document.getElementById('panel-recent').style.display='';document.getElementById('panel-popular').style.display='none';this.className='px-3 py-1.5 text-sm font-bold transition-colors text-primary-600 dark:text-primary-400 border-b-2 border-primary-600 dark:border-primary-400';document.getElementById('tab-popular').className='px-3 py-1.5 text-sm font-bold transition-colors text-gray-500';" class="px-3 py-1.5 text-sm font-bold transition-colors text-primary-600 dark:text-primary-400 border-b-2 border-primary-600 dark:border-primary-400">Newest Releases</button>
                    <button id="tab-popular" onclick="document.getElementById('panel-popular').style.display='';document.getElementById('panel-recent').style.display='none';this.className='px-3 py-1.5 text-sm font-bold transition-colors text-primary-600 dark:text-primary-400 border-b-2 border-primary-600 dark:border-primary-400';document.getElementById('tab-recent').className='px-3 py-1.5 text-sm font-bold transition-colors text-gray-500';" class="px-3 py-1.5 text-sm font-bold transition-colors text-gray-500">Most Popular</button>
                </div>
                <div id="panel-recent">
